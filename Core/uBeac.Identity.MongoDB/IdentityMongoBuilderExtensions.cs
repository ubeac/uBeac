...
{
    public static class IdentityMongoBuilderExtensions
    {
        ...
        where TRoleClaim : IdentityRoleClaim<TKey>, new()
        {
            ...
            builder.Services.AddSingleton(provider =>
            {
                ...
                return options.Value ?? new MongoDBIdentityOptions();
            });
            ...
            builder.Services.AddSingleton(provider =>
            {
                ...
                return new IdentityMongoDatabase(client.GetDatabase(mongoUrl.DatabaseName));
            });

            builder.Services.AddScoped<IUserStore<TUser>, UserStore<TUser, TRole, TKey, TUserClaim, TUserRole, TUserLogin, TUserToken, TRoleClaim>>();
            builder.Services.AddScoped<IRoleStore<TRole>, RoleStore<TRole, TKey, TUserRole, TRoleClaim>>();
